...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001929283683'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6073523936').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001929283683').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001929283683') # give your force subscribe channel id here else leave it blank
